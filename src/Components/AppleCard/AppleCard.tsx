...
export const Carousel = ({ items, initialScroll = 0 }: CarouselProps) => {
  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    const walk = (x - startX) * 2; // The multiplier controls the speed of the scroll
  ...
  return (
    ...
    >
      <div className="relative w-full">
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto py-6 md:py-20 scroll-smooth [scrollbar-width:none] pl-6 cursor-grab active:cursor-grabbing"
          ref={carouselRef}
...
export const CarouselCard = ({
  ...
  const handleRedirect = () => {
    const urls: { [key: string]: string } = {
      1: "https://cmcya.mx",
      2: "https://fratellishelados.com",
      3: "https://hilitoslili.com",
      4: "https://mgsi.mx",
      5: "https://orzatech.com",
      6: "https://psiqueyser.org",
      7: "https://rondoproductions.com/",
      8: "https://salomon-mtz.github.io/sp.github.io/",
